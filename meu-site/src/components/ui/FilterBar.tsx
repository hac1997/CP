    ...
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="flex items-end">
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-lg hover:from-gray-200 hover:to-gray-300 transition-all duration-300 font-semibold whitespace-nowrap shadow-sm hover:shadow-md"
        >
          Limpar
        </button>
      </div>
