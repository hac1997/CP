...
export const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white shadow-sm w-full fixed top-0 z-50 font-sans">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-6 py-3">
          ...
          <button
            ...
            className="lg:hidden p-2 text-gray-700 rounded-lg hover:bg-gray-100 focus-visible:ring-2 focus-visible:ring-blue-500"
      ...
      {/* Secondary Navigation - Internal Links (Desktop) */}
        ...
        <>
          ...
          >
            <div className="flex justify-between items-center">
              <span className="font-semibold text-lg text-gray-800" style={{ fontFamily: "Montserrat, sans-serif" }}>
                Menu
              </span>
              <button
                onClick={closeMenu}
                onKeyDown={(e) => handleKeyDown(e, closeMenu)}
                className="p-2 rounded-lg hover:bg-gray-100 focus-visible:ring-2 focus-visible:ring-blue-500"
                aria-label="Fechar menu"
              >
                <X size={24} />
              </button>
