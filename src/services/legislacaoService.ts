// src/services/legislacaoService.ts
import { Legislacao } from '@/types/legislacao';
import { parseCSVLine, splitCSVLines } from '@/lib/csvUtils';

const URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR5fLkEGvYwDWreyCq0xLorJ0NbuqR1oFAQC76LBrkJY6ZR7RAKRRVVLQWa0CWgJRgrfdSJNX2iqkaG/pub?gid=6959380&single=true&output=csv';
...
export async function fetchLegislacoesFromSheets(): Promise<Legislacao[]> {
  try {
    ...
    return parseCSVToLegislacoes(csv);
  } catch {
    return [];
  }
}
